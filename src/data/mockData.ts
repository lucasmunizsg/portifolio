...
export const skillsData: Skill[] = [
    ...
    { id: "14", name: "Testes (UnitTest, Cypress)", category: "Progresso", yearLearned: 2023, usageTime: "+ de 2 anos de uso" },
    { id: "15", name: "Introdução a Machine Learning", category: "Progresso", yearLearned: 2023, usageTime: "+ de 2 anos de uso" },
    { id: "16", name: "Computer Science", category: "Progresso", yearLearned: 2024, usageTime: "+ de 2 anos de uso" },
    { id: "17", name: "Metodologias Ágeis", category: "Progresso", yearLearned: 2018, usageTime: "+ de 2 anos de uso" },
    { id: "18", name: "Power BI", category: "Progresso", yearLearned: 2023, usageTime: "+ de 2 anos de uso" },
    { id: "19", name: "Inglês (Em andamento)", category: "Progresso", yearLearned: 2025, usageTime: "+ de 2 anos de uso" }
];
